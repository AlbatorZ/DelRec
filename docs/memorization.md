...
| --- | --- | --- |
| Axonal | `SNN_axonal_recurrent_delays` | `SNN_axonal_feedforward_delays` |
| Synaptic | `SNN_synaptic_recurrent_delays` | `SNN_synaptic_feedforward_delays` |
| Hybrid | `SNN_recurrent_hybrid_delays` | `SNN_hybrid_feedforward_delays` |
